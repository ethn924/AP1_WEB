                    ...
                    <?php while ($cr = mysqli_fetch_assoc($derniers_cr_result)): ?>
                        <li class="cr-item">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <strong><?php echo strip_tags(substr($cr['description'], 0, 100)) . (strlen($cr['description']) > 100 ? '...' : ''); ?></strong>
                                ...
                                <div>
                                    <span
                                        style="margin-right: 15px; <?php echo $cr['vu'] ? 'color: green;' : 'color: red;'; ?>">
                                        <?php echo $cr['vu'] ? '✅ Consulté' : '❌ Non consulté'; ?>
                                    </span>
                                    <a href="liste_cr.php?detail=<?php echo $cr['num']; ?>" class="btn"
                                        style="font-size: 12px;">Voir détails</a>
                                </div>
                            </div>
                        </li>
                    <?php endwhile; ?>
                ...
                <?php while ($commentaire = mysqli_fetch_assoc($commentaires_result)): ?>
                    <div class="comment-item">
                        ...
                        <div style="text-align: right; margin-top: 10px;">
                            <a href="liste_cr.php?detail=<?php echo $commentaire['cr_id']; ?>"
