            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control"
                        required><?php echo $modele ? htmlspecialchars($modele['description']) : ''; ?></textarea>
                    <small style="color: #666;">
                        Expliquez aux élèves l'objectif de ce modèle et comment l'utiliser.<br>
                        Exemples : "Ce modèle sert à décrire les tâches réalisées cette semaine.", "Remplissez chaque
                        section avec vos observations."
                    </small>
                </div>
                <div class="form-group">
                    <label for="contenu_html">Contenu du modèle (structure et guide) *</label>
                    <textarea id="contenu_html" name="contenu_html" class="form-control" required
                        style="min-height: 300px;"><?php echo $modele ? htmlspecialchars($modele['contenu_html']) : ''; ?></textarea>
                    <small style="color: #666;">
                ...
                <?php while ($modele_item = mysqli_fetch_assoc($modeles_result)): ?>
                    <div class="modele-item">
                        ...
                        <div class="modele-actions">
                            ...
                            <a href="gestion_modeles_checklists.php?id=<?php echo $modele_item['id']; ?>" class="btn">Gérer
                                Checklist</a>
