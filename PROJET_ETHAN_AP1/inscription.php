    ...
    <?php else: ?>
        ...
        <form method="POST">
            ...
            <input type="text" id="prenom" name="prenom"
                value="<?php echo isset($_POST['prenom']) ? htmlspecialchars($_POST['prenom']) : ''; ?>" required><br><br>

            <label for="login">Login :</label><br>
            <input type="text" id="login" name="login"
                value="<?php echo isset($_POST['login']) ? htmlspecialchars($_POST['login']) : ''; ?>" required><br><br>
            ...
            <select id="type" name="type" required>
                <option value="0" <?php echo (isset($_POST['type']) && $_POST['type'] == '0') ? 'selected' : ''; ?>>Étudiant
                </option>
                <option value="1" <?php echo (isset($_POST['type']) && $_POST['type'] == '1') ? 'selected' : ''; ?>>Professeur
                </option>
            </select><br><br>
