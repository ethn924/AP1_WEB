    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="current-info">
                ...
                <?php echo date('d/m/Y à H:i', strtotime($cr['datetime'])); ?><br>
                        ...
                        <div class="version-header">
                            <div>
                                ...
                                <div class="version-meta">
                                    par
                                    <strong><?php echo htmlspecialchars($version['prenom'] . ' ' . $version['nom']); ?></strong>
                                    le <?php echo date('d/m/Y à H:i', strtotime($version['date_creation'])); ?>
                                </div>
                            </div>
                            <span
                                class="version-badge <?php echo $version['numero_version'] == $cr['num_version'] ? 'current' : ''; ?>">
