...
?>
    ...
    <body>
        ...
        <?php if ($_SESSION['Stype'] == 0): ?>
            <h3>Menu Élève</h3>
            <ul>
                <li><a href="tableau_bord_eleve.php" style="color: #28a745; font-weight: bold; font-size: 1.1em;">📊 Tableau de bord</a></li>
        ...
        <?php else: ?>
            ...
            <ul>
                <li><a href="tableau_bord_prof.php" style="color: #28a745; font-weight: bold; font-size: 1.1em;">👨‍🏫 Tableau de bord</a></li>
