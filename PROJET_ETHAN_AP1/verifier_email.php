...
<body>
    ...
    <p>Veuillez vérifier votre adresse email <strong><?php echo htmlspecialchars($email); ?></strong> pour activer votre compte.</p>
    ...
    <?php else: ?>
        <form method="POST">
            ...
            <input type="text" id="code_verification" name="code_verification" required maxlength="6" pattern="[0-9]{6}"><br><br>
