...
// Traitement de la mise à jour des validations
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_validation'])) {
    $checklist_item_id = intval($_POST['checklist_item_id']);
    
    if (isset($_POST['complete'])) {
        if (marquerChecklistComplete($cr_id, $checklist_item_id)) {
            $message = "Élément de checklist marqué comme complété.";
        } else {
...
// Récupérer le modèle utilisé pour ce CR (si applicable)
// Pour ce simple système, on suppose qu'il n'y a pas de lien direct entre CR et modèle
// dans la structure actuelle, donc on va afficher un message d'information
    ...
    <div class="container">
        <div class="header">
            ...
            <div>
                ...
                <a href="<?php echo $_SESSION['Stype'] == 0 ? 'tableau_bord_eleve.php' : 'tableau_bord_prof.php'; ?>" class="btn btn-secondary">📊 Tableau de bord</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <p><strong>Description:</strong> <?php echo htmlspecialchars(substr($cr['description'], 0, 200)); ?></p>
        </div>
