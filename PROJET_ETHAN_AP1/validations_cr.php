            ...
            <div class="card">
                ...
                <form method="POST" action="">
                    <?php foreach ($validations as $validation): ?>
                        <div
                            class="checklist-item <?php echo $validation['complete'] ? 'complete' : ''; ?> <?php echo $validation['obligatoire'] ? 'obligatoire' : ''; ?>">
                            <div class="checklist-header">
                                <input type="checkbox" class="checklist-checkbox"
                                    id="item_<?php echo $validation['checklist_item_id']; ?>" <?php echo $validation['complete'] ? 'checked' : ''; ?>
